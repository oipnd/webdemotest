...
<body id="thisbody" onload="alertNum();browerInfo();getCoordInDocumentExample()" onkeydown="keyDown()" onkeyup="keyUp()"  onmousedown="mousedown_sendXML()" onmouseup="mouseup_sendXML()">
  <section class="container">
  
    <div class="login">
      <h1 id="title_h1"><font id="title_font" size="6.8">欢迎进入改密数据采集</font>
<!--           <font id="title_font" size="3">应用缓冲采集</font> -->
      </h1>
      
      <form id="form1" name="form1" method="post" action="/WebDemoTest/CollectServlet">
        <input type="hidden" name="method" value="changePwdCollect" />
