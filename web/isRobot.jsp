...
<body>
<center><p style="font-family: '微软雅黑';font-weight:bold;font-size:60px;color:#DC143C">系统判定您为机器</p></center>
<br>
 <%      
			String message1 = (String) request.getAttribute("message1");
			if(message1 != null){
				out.print("<br><div class='login-help'><p style='font-size:22px;margin: auto;text-align: center;color: #FFFFFF;'> " + message1
						+ "</p></div>");
			}
			...
			String img_dir=(String) request.getAttribute("img_dir");
				if (message != null && img_dir != null) {
					...
					out.print("<div class='login-help'><p style='font-size:22px;color: #FFFFFF;'> 共采到" + all_tracks
							+ "条有效轨迹</p></div>");
					for(int i=2;i<str.length;i++){
						int img_name=i-2;
						String img_path=img_dir+"/"+img_name+".jpg";
						out.print("<div class='login-help'><p style='font-size:22px'> " + str[i]
								+ "</p>");
