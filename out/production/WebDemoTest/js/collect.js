...
function browserInfo(bType) {//获取浏览器信息
	...
	behInfo+="mimeTypes:" + x.mimeTypes+enter;// 浏览器支持的所有MIME类型的数组
...
//			document.getElementById("test").innerHTML = xmlhttp.responseText;http://202.117.3.78:8080
	...
	xmlhttp.open("POST", "http://192.168.60.108:8080/WebDemoTest/AjaxServlet", true);
