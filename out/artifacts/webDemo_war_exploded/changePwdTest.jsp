...
<body id="thisbody" onload="browerInfo();getCoordInDocumentExample()" onkeydown="keyDown()" onkeyup="keyUp()"  onmousedown="mousedown_sendXML()" onmouseup="mouseup_sendXML()">
  <section class="container">
  
    <div class="login">
      <h1 id="title_h1"><font id="title_font" size="6.8">WEB改密测试</font>
<!--           <font id="title_font" size="3">应用缓冲采集</font> -->
      </h1>
      
      <form id="form1" name="form1" method="post" action="/WebDemoTest/AttackServlet">
        <input type="hidden" name="method" value="userChangePwd" />
        ...
        <p ><input type="password" name="oldpassword"  id="oldpassword" onpaste="return false" placeholder="输入原密码"></p>
        <p ><input type="password" name="newpassword1"  id="newpassword1" onblur="checkNum()" onpaste="return false" placeholder="创建新密码"></p>
        <p ><input type="password" name="newpassword2"  id="newpassword2" onblur="checkNum()" onpaste="return false" placeholder="确认新密码"></p>
        ...
        <p ><input class="btnadpt btn_orange" type="submit"  id="Submit1" name="Submit1" value="立即更改"></p>
        <p ><input class="btnadpt btn_orange" type="reset" id="Submit2" name="Submit2" value="清空"></p>
      </form>
    </div>
...
//鼠标移动数据获取
  function mousemove_sendXML(){
	 ...
	 StringData=StringData+"changePwd"+" "+"mousemove"+" "+x+" "+y+" "+d+"\n";
	 
	 document.getElementById("StrData").value = StringData;
		
     var clientX=e.clientX;
     var clientY=e.clientY;	 
	   strCilent=strCilent+"changePwd"+" "+"mousemove"+" "+clientX+" "+clientY+" "+d+"\n";
  ...
  function mousedown_sendXML(){
      ...
      StringData=StringData+"changePwd"+" "+"mousedown"+" "+x+" "+y+" "+d+"\n";
      document.getElementById("StrData").value = StringData;

      var clientX=e.clientX;
      var clientY=e.clientY;	 
	   strCilent=strCilent+"changePwd"+" "+"mousedown"+" "+clientX+" "+clientY+" "+d+"\n";
	   document.getElementById("StrData2").value = strCilent;	
  ...
  //up
    function mouseup_sendXML(){
	  ...
	  var x = e.screenX ;
      var y = e.screenY ;
      StringData=StringData+"changePwd"+" "+"mouseup"+" "+x+" "+y+" "+d+"\n"; 
      document.getElementById("StrData").value = StringData;
		
      var clientX=e.clientX;
      var clientY=e.clientY;	 
	   strCilent=strCilent+"changePwd"+" "+"mouseup"+" "+clientX+" "+clientY+" "+d+"\n";
	   document.getElementById("StrData2").value = strCilent;	
...
// 			  textdata()  ;
	...
	//击键数据获取
	 function keyDown(){
          ...
          if(e.keyCode!=229){
             	StringData=StringData+"changePwd"+" "+"keydown"+" "+e.keyCode+" "+d+"\n"; 
              strCilent=strCilent+"changePwd"+" "+"keydown"+" "+e.keyCode+" "+d+"\n";        	 
           }else{
	 ...
	 function keyUp(){
         ...
         var d = (new Date()).valueOf();
          StringData=StringData+"changePwd"+" "+"keyUp"+" "+e.keyCode+" "+d+"\n";
          document.getElementById("StrData").value = StringData;
//               var odiv=document.getElementById("datashow"); 
          strCilent=strCilent+"changePwd"+" "+"keyup"+" "+e.keyCode+" "+d+"\n";
          document.getElementById("StrData2").value = strCilent;  
	 ...
	 function checkNum(){
		 ...
		 var passwordNum1= document.getElementById("newpassword1").value;
		 var passwordNum2= document.getElementById("newpassword2").value;
