(function ($) {
    ...
    $.fn.jquizzy = function (settings) {
        var defaults = {
            ...
            endText: '已结束!',//end
            shortURL: null,
            sendResultsURL: 'http://192.168.60.80:8080/WebDemoTest/AnswerServlet',
            resultComments: {
        ...
        var superContainer = $(this),
            ...
            introFob = '	<div class="intro-container slide-container"><a class="nav-start" href="#">说明：这里有一些适合或不适合你的特征。例如，你是否同意你喜欢花时间和别人呆在一起？请选中最适合你的选项，指明你在多大程度上同意或不同意该描述。<br/><br/><span><img src="' + config.startImg + '"></span></a></div>	',
        ...
        superContainer.find('.final').click(function () {
            ...
            if (config.sendResultsURL !== null) {
                ...
                // 发送答案数据
                var uid = document.getElementsByName("studentno").value;
                var date = new Date();
                ...
                //var data = 'uid=' + uid & 'fpath=' + fpath & 'txt=' + txt & 'answers=' + '{"answers": [' + collate.join(",") + ']}';
