...
<html >
  ...
  <body >
   <%--  <%response.sendRedirect("/WebDataTest/login.jsp"); %> --%>
     ...
     <center><p style="font-family: '微软雅黑';font-weight:bold;font-size:70px;color:#D52B2B">注意评估数据采集系统</p></center>
...
<!-- 	</a></center> -->
	...
	<p style="font-family: '微软雅黑';font-weight:bold;font-size:45px;color:#445cbb">数据采集系统系统入口</p>
	</a></center>
  <br>
	  <br>
	   <br>
