...
<body id="thisbody" onload="browerInfo();getCoordInDocumentExample()" onkeydown="keyDown()" onkeyup="keyUp()"  onmousedown="mousedown_sendXML()" onmousemove="mousemove_sendXML()" onmouseup="mouseup_sendXML()" >
  <section class="container">
     ...
     <br>
    <div class="login">
      <h1 id="title_h1"><font id="title_font" size="6.8">欢迎进行人机检测</font>
...
<!--          title="看不清换一张" onclick="refreshcode()"></p>     -->
    ...
    <br><div class='login-help'><p style='font-size:20px;font-family:微软雅黑;'><a href="/WebDemoTest/menu.jsp"> 返回系统目录<a></p></div>
      
    <%      
            String warning = (String)request.getAttribute("textnum");
			String message = (String) request.getAttribute("message");
			if (message != null) {
				out.print("<br><div class='login-help'><p style='font-size:22px'font-family:微软雅黑;color:#EE0000> " + message
						+ "</p></div>");
			}
		%>
 </section>
...
// 				  function(){  
// 					  window.location.href="/WebDemoTest/menu.jsp";	});
// 		  }
//       }
